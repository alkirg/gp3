        ...
        <div class="random-product-container">
            ...
            <div class="random-product-container__content">
                <div class="item-product">
                    <div class="item-product__title-product"><a href="{{$randomProduct->url()}}" class="item-product__title-product__link">{{$randomProduct->name}}</a></div>
                    <div class="item-product__thumbnail"><a href="{{$randomProduct->url()}}" class="item-product__thumbnail__link"><img src="{{$storage->url($randomProduct->preview_picture)}}" alt="Preview-image" class="item-product__thumbnail__link__img"></a></div>
                    <div class="item-product__description">
                        <div class="item-product__description__products-price"><span class="products-price">{{$randomProduct->price}} руб</span></div>
                        <div class="item-product__description__btn-block"><a href="{{$randomProduct->cart()}}" class="btn btn-blue">Купить</a></div>
                    </div>
                </div>
            </div>
        </div>
