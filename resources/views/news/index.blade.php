            ...
            <div class="content-main__container">
                <div class="news-list__container">
                    <div class="news-list__item">
                        <div class="news-list__item__thumbnail"><img src="{{asset('img/news/ps_vr.jpg')}}"></div>
                    ...
                    <div class="news-list__item">
                        <div class="news-list__item__thumbnail"><img src="{{asset('img/news/ps4-pro_01.jpg')}}"></div>
                        <div class="news-list__item__content">
